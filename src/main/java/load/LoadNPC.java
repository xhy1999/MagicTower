...
public class LoadNPC {
    ...
    public Map<String, NPC> initNPC() {
        ...
        dialogues.add(new Dialogue("elf", "放心吧,我把我的力量借给你,你就可以打赢那些小怪了。不过,你得先帮我去找一样东西,找到了再来这里找我。"));
        ...
        dialogues.add(new Dialogue("elf", "我本是这座塔的守护者,可不久前,从北方来了一批恶魔,他们占领了这座塔,并将我的魔力封印在这个十字架里面,如果你能将它带出塔来,那我的魔力便会慢慢地恢复,到那时候,我便可以把力量借给你去救公主了。"));
        dialogues.add(new Dialogue("elf", "要记住:只有用我的魔力才可以打开21层的门。"));
        dialogues.add(new Dialogue("player", "......好吧,我试试看。"));
        dialogues.add(new Dialogue("elf", "刚才我去看过了,你的剑被放在3楼,你的盾在5楼上,那个十字架被放在7楼。要到7楼,你得先取回你的剑和盾。另外,在塔里的其他楼层上,还存放了好几百年的宝剑和宝物,如果得到他们,对于你对付里面的怪物将有很大的帮助。"));
        ...
        NPC npc = new NPC("npc01_1", "仙子", true,
